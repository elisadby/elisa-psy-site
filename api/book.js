    ...
    <div style="padding:36px 36px 28px;">
      ...
      <div>
        ...
        <p style="margin:0;font-size:13px;color:${muted};line-height:1.7;">Pour annuler ou déplacer un rendez-vous, veuillez me contacter :<br>
          <a href="tel:+33743777257" style="color:${accent};text-decoration:none;">07 43 77 72 57</a> · <a href="mailto:${process.env.PRAT_EMAIL}" style="color:${accent};text-decoration:none;">${process.env.PRAT_EMAIL}</a>
        </p>
      </div>
